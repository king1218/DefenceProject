  ...
  return (
   ...
   <Nav></Nav>
    ...
    <Route path='/' element={<HomePage/>}></Route>
        ...
        <Route path='/appliedJobs' element={<RequireAuth><AppliedJobs/></RequireAuth>}></Route>
        ...
        <Route path='/dashboard/allUsers' element={<RequireAdmin><AllUsers/></RequireAdmin>}></Route>
        <Route path='/dashboard/allJobs' element={<RequireAdmin><AllJobs/></RequireAdmin>}></Route>
        <Route path='/dashboard/allReviews' element={<RequireAdmin><AllReviews/></RequireAdmin>}></Route>
        </Route>
