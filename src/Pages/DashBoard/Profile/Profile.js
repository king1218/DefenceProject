  ...
  if(error){
    ...
    return (
       ...
       <div className='bg-indigo-100 p-5 mt-4 rounded-xl'>
          <h1 className='text-indigo-700 text-2xl '>{user?.displayName}</h1> 
      ...
      <div className='bg-indigo-100 p-5 mt-4 rounded-xl'>
        ...
        <div className='flex justify-center items-center '>
          ...
          <div>
          <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold '>University</h1>
        <p className="  my-2">{User?.University}</p>
        </div>
          <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold'>Student Id</h1>
        <p className="   my-2">{User?.Student_ID}</p>
        </div>
          <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold'>Department Or Subject</h1>
        <p className="  my-2">{User?.Department}</p>
        </div>
          <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold'>Year Or Semester</h1>
        <p className="  my-2">{User?.Year_OR_Semester}</p>
        </div>
          </div>
        </div>
        ...
        <div className='flex justify-center items-center '>
         ...
         <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold'>About You</h1>
        <p className="  my-2">{User?.Description}</p>
        </div>
         <div className='mt-3'>
        <h1 className='   text-indigo-700 font-bold'>Experience</h1>
        <p className="  my-2">{User?.Experience}</p>
        </div>
        </div>
      </div>
