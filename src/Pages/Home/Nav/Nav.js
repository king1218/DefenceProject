...
const Nav= () => {
    ...
    const menuItems = <>
        ...
        
        {
          user &&
            <>
            <li><Link className='hover:bg-indigo-700 hover:text-white hover:-translate-y-1  hover:scale-110 transition duration-200' to="/appliedJobs">Applies</Link>
            </li>
            <li>
              <Link className='hover:bg-indigo-700 hover:text-white hover:-translate-y-1  hover:scale-110 transition duration-200' to="/dashboard">Dashboard</Link>
            </li>
            </>
        }
        {
