...
const JobCategory = () => {
  ...
  const {data:Categories,isLoading,refetch,error}=useQuery('categories',()=>fetch('https://quick-solution-server.up.railway.app/categories',
  {
      method: 'GET',
      headers: {
  ...
  if(isLoading||jobsLoading||loading){
